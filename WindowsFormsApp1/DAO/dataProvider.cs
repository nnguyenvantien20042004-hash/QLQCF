...
namespace WindowsFormsApp1.DAO
{
    ...
    {
        private string dataSrc = "Data Source=DESKTOP-RC6CDRN\\SQLEXPRESS; Initial Catalog = QuanLiQuanCafe; Integrated Security = True";
        ...
        public void excuteNonQuerry(string querry, object[] Parameter = null)
        {
            using (SqlConnection connection = new SqlConnection(dataSrc))
            {
                ...
                command.ExecuteNonQuery();   // QUAN TRỌNG
                connection.Close();
            }
        }
